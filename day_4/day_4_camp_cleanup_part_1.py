...
def __main__():
    ...
    with open('day_4_input.txt', 'r') as file:
        for line in file:
            ...
            counter.append(all(item in sections_of_first_elf for item in sections_of_second_elf) or all(item in sections_of_second_elf for item in sections_of_first_elf))
